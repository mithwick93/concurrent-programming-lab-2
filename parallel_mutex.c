 ...
 *
 * Compile:     gcc -g -Wall -o parallel_mutex parallel_mutex.c -lm -lpthread
 *
 * Run:         ./parallel_mutex <number of threads> <sample size> <n> <m> <mMember> <mInsert> <mDelete>
...
void program_help(char *programme_name);
